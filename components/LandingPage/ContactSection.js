...
export default function ContactSection() {
  return (
    <>
      ...
      <div className="font-sans w-96 mx-auto text-accent-1-lighter text-xl text-center mb-20">
        Find me at these places. Unfortunately, I am an extremely online person,
        so you'll probably get quick response.
      </div>
      <div className="flex flex-col md:flex-row md:mx-40 xl:mx-96 text-center mt-12 text-white text-6xl space-y-6 md:space-y-0 md:text-7xl justify-evenly">
