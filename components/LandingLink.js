...
export default function LandingLink({ text, link, description }) {
  return (
    <div className="text-white my-10 text-left text-8xl xl:text-9xl font-display md:w-1/2 mx-10 md:mx-auto">
      <div className="group w-[50%] flex space-x-2 xl:space-x-10 items-center transition-all duration-500">
        ...
        <span className="hidden mix-blend-screen leading-snug text-accent-1-lighter xl:flex pointer-events-none my-auto font-sans w-3/4 text-left text-sm md:text-lg mx-0 transform group-hover:translate-x-16 duration-500 opacity-0 group-hover:opacity-100 transition-all">
          {description}
        </span>
