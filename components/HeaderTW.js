...
export const HeaderTW = () => {
  return (
    <>
      {/* header itself */}
      <div className="relative bg-accent-1 mb-10 md:py-6 md:mb-20">
        {/* div for all three elements */}
        <div className="flex flex-row mx-auto items-center md:py-6">
          {/* logo */}
          <div className="m-2 justify-center align-middle w-1/2 md:w-1/4 md:mx-10 md:transform md:scale-250">
            <a href="/">
