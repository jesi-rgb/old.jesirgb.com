...
export default function Blog() {
  let works = [
...

    {
      ...
      subtitle:
        "This category includes all the video work I've participated on, either co-producing it or adding some small animations",
      works: [
        {
          title:
            ...
            {works.map((c) => {
              return (
                <div className="text-white">
                  <div className="mb-10 font-display font-bold text-2xl xl:text-4xl">
                    <a
